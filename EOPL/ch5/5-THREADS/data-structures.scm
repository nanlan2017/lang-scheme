(module data-structures (lib "eopl.ss" "eopl")
  ...
  ;;; The first binding for extend-env, the second is forextend-env-rec. 

  ;;; this representation is designed to make the printed representation of the environment more readable.
  ;;; This should probably be factored out into a module called environments.scm, like it is in most of the other interpreters.
  ...
  (define apply-env
    (lambda (env search-sym)
      (if (null? env) 
          ...
          (let* ((binding (car env))
                 (saved-env (cdr env)))
            (if (symbol? (car binding)) ;; ok, this is an extend-env                
